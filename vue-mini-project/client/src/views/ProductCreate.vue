    ...
    <div>
        <main class="mt-3">
            <div class="container">
                ...
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-md-3 col-form-label">제품명</label>
                    <div class="col-md-9">
                ...
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-md-3 col-form-label">태그</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" >
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-md-3 col-form-label">썸네일이미지</label>
                    <div class="col-md-9">
                ...
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-md-3 col-form-label">제품이미지</label>
                    <div class="col-md-9">
                ...
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-md-3 col-form-label">제품설명이미지</label>
                    <div class="col-md-9">
                        <input type="file" class="form-control" accept="image/png,image/jpeg" >
                        <div class="alert alert-secondary" role="alert">
                            <ul>
                ...
                <div class="mb-3 row">
                    <div class="d-flex justify-content-between align-content-center ">
                        <div class="col-6 d-grid p-1">
                            <button class="btn btn-lg btn-dark">취소하기</button>
                        </div>
                        <div class="col-6 d-grid p-1">
                            <button class="btn btn-lg btn-danger">저장하기</button>
                        </div>
                    </div>
                </div>
            </div>
