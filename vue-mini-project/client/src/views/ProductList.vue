        ...
        <main class="mt-3">
            <div class="container">
                ...
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6">
                        <div class="card" style="width: 18rem;">
                            <a href="product_detail.html">
                                <img src="http://thumbnail.10x10.co.kr/webimage/image/basic/381/B003819928-1.jpg?cmd=thumb&w=500&h=500&fit=true&ws=false" class="card-img-top" alt="...">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card" style="width: 18rem;">
                            <img src="https://imgcdn.uuumall.kr/product/2022041209530001/14760/default/14760_20220422151026.jpg?w=0&h=0&f=jpeg&q=60" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">맥스틸 무선 블루투스 마우스 블랙 무소음 노트북 갤럭시탭 저소음</h5>
                                <p class="card-text">
                                    <span class="badge bg-secondary">전제제품</span>
                                    <span class="badge bg-secondary">컴퓨터</span>
                                    <span class="badge bg-secondary">악세사리</span>
                                ...
                                <div class="d-flex justify-content-between align-content-center">
                                    ...
                                    <small class="text-dark">329,000원</small>
                                </div>
                            </div>
                        </div>
                    </div>
